...
今回はこの通りに、実装をしていこうと思います。

jwt 公式からは様々な言語の library が準備されています。このライブラリを活用しながら認証機能を作っていきます。

https://jwt.io/libraries

今回は TypeScript を用いて書いていこうと思います。
...
今回は、1 時間有効の jwt に、userId, userId と isAdmin の情報を入れてみましょう。
