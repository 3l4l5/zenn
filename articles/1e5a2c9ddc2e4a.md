---
title: "オブジェクト指向で書く！テストのしやすいソースコード！"
emoji: "🖋"
...
関数の組み合わせで作られているテストしにくいプログラムから、オブジェクト指向で書かれたテストのしやすいプログラムにリファクタリングを行う中で、クラスを用いてプログラムを書くとどのような嬉しいことがあるのかについて説明させていただければと思います。
